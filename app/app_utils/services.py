...
def get_memory_service():
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", "2840528366975582208")
    if agent_engine_id:
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-97c80a1d932c"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
